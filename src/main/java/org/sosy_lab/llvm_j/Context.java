...
public class Context {
   ...
   * Every call to this function should be paired with a call to {@link #dispose()} or the context
   * will leak memory.
   */
   ...
   * This should be called whenever a {@link Context} instance is not needed anymore, or memory will
   * be leaked.
   */
  public void dispose() {
    if (context != null) {
