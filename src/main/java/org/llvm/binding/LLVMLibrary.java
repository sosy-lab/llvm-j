...
public class LLVMLibrary implements Library {
	...
	/**
	 * Instantiates the LLVM library for use by loading the native LLVM library.
	 * This method must be called once before the other static methods of this class can be used.
	 */
	...
	public static native void LLVMPassManagerBuilderDispose(LLVMLibrary.LLVMPassManagerBuilderRef PMB);
	/**
	 ...
	 */
	public static native void LLVMPassManagerBuilderSetOptLevel(LLVMLibrary.LLVMPassManagerBuilderRef PMB, int OptLevel);
	/**
	 ...
	 */
	public static native void LLVMPassManagerBuilderSetSizeLevel(LLVMLibrary.LLVMPassManagerBuilderRef PMB, int SizeLevel);
	/**
	 ...
	 */
	public static native void LLVMPassManagerBuilderSetDisableUnitAtATime(LLVMLibrary.LLVMPassManagerBuilderRef PMB, LLVMLibrary.LLVMBool Value);
	/**
	 ...
	 */
	public static native void LLVMPassManagerBuilderSetDisableUnrollLoops(LLVMLibrary.LLVMPassManagerBuilderRef PMB, LLVMLibrary.LLVMBool Value);
	/**
	 ...
	 */
	public static native void LLVMPassManagerBuilderSetDisableSimplifyLibCalls(LLVMLibrary.LLVMPassManagerBuilderRef PMB, LLVMLibrary.LLVMBool Value);
	/**
	 ...
	 */
	public static native void LLVMPassManagerBuilderUseInlinerWithThreshold(LLVMLibrary.LLVMPassManagerBuilderRef PMB, int Threshold);
	/**
	 ...
	 */
	public static native void LLVMPassManagerBuilderPopulateFunctionPassManager(LLVMLibrary.LLVMPassManagerBuilderRef PMB, LLVMLibrary.LLVMPassManagerRef PM);
	/**
	 ...
	 */
	public static native void LLVMPassManagerBuilderPopulateModulePassManager(LLVMLibrary.LLVMPassManagerBuilderRef PMB, LLVMLibrary.LLVMPassManagerRef PM);
	/**
	 ...
	 */
	public static native void LLVMPassManagerBuilderPopulateLTOPassManager(LLVMLibrary.LLVMPassManagerBuilderRef PMB, LLVMLibrary.LLVMPassManagerRef PM, LLVMLibrary.LLVMBool Internalize, LLVMLibrary.LLVMBool RunInliner);
	/**
	 ...
	 */
	public static native void LLVMAddCorrelatedValuePropagationPass(LLVMLibrary.LLVMPassManagerRef PM);
	/**
	 ...
	 * @deprecated use the safer methods {@link #LLVMCreateMessage(java.lang.String)} and {@link #LLVMCreateMessage(com.sun.jna.Pointer)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #LLVMDisposeMessage(java.nio.ByteBuffer)} and {@link #LLVMDisposeMessage(com.sun.jna.Pointer)} instead
	 */
	@Deprecated 
	 ...
	 */
	public static native void LLVMContextSetDiagnosticHandler(LLVMLibrary.LLVMContextRef C, LLVMLibrary.LLVMDiagnosticHandler Handler, Pointer DiagnosticContext);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMDiagnosticHandler LLVMContextGetDiagnosticHandler(LLVMLibrary.LLVMContextRef C);
	/**
	 ...
	 */
	public static native void LLVMContextSetYieldCallback(LLVMLibrary.LLVMContextRef C, LLVMLibrary.LLVMYieldCallback Callback, Pointer OpaqueHandle);
	/**
	...
	public static native int LLVMGetMDKindIDInContext(LLVMLibrary.LLVMContextRef C, String Name, int SLen);
	/**
	 * Original signature : <code>int LLVMGetMDKindID(const char*, unsigned)</code><br>
	 * @deprecated use the safer methods {@link #LLVMGetMDKindID(java.lang.String, int)} and {@link #LLVMGetMDKindID(com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
	 ...
	 * @deprecated use the safer methods {@link #LLVMGetEnumAttributeKindForName(java.lang.String, com.ochafik.lang.jnaerator.runtime.NativeSize)} and {@link #LLVMGetEnumAttributeKindForName(com.sun.jna.Pointer, com.ochafik.lang.jnaerator.runtime.NativeSize)} instead
	 */
	@Deprecated 
	 ...
	 */
	public static native LLVMLibrary.LLVMAttributeRef LLVMCreateEnumAttribute(LLVMLibrary.LLVMContextRef C, int KindID, long Val);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMAttributeRef LLVMCreateStringAttribute(LLVMLibrary.LLVMContextRef C, String K, int KLength, String V, int VLength);
	/**
	 ...
	 */
	public static native String LLVMGetStringAttributeKind(LLVMLibrary.LLVMAttributeRef A, IntBuffer Length);
	/**
	 ...
	 */
	public static native String LLVMGetStringAttributeValue(LLVMLibrary.LLVMAttributeRef A, IntBuffer Length);
	/**
	 ...
	 * @deprecated use the safer methods {@link #LLVMModuleCreateWithName(java.lang.String)} and {@link #LLVMModuleCreateWithName(com.sun.jna.Pointer)} instead
	 */
	@Deprecated 
	 ...
	 */
	public static native String LLVMGetModuleIdentifier(LLVMLibrary.LLVMModuleRef M, NativeSizeByReference Len);
	/**
	 ...
	 */
	public static native void LLVMSetModuleIdentifier(LLVMLibrary.LLVMModuleRef M, String Ident, NativeSize Len);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBool LLVMPrintModuleToFile(LLVMLibrary.LLVMModuleRef M, String Filename, PointerByReference ErrorMessage);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMTypeRef LLVMGetTypeByName(LLVMLibrary.LLVMModuleRef M, String Name);
	/**
	 ...
	 */
	public static native int LLVMGetNamedMetadataNumOperands(LLVMLibrary.LLVMModuleRef M, String Name);
	/**
	 ...
	 */
	public static native void LLVMGetNamedMetadataOperands(LLVMLibrary.LLVMModuleRef M, String Name, LLVMLibrary.LLVMValueRef Dest);
	/**
	 ...
	 */
	public static native void LLVMAddNamedMetadataOperand(LLVMLibrary.LLVMModuleRef M, String Name, LLVMLibrary.LLVMValueRef Val);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMAddFunction(LLVMLibrary.LLVMModuleRef M, String Name, LLVMLibrary.LLVMTypeRef FunctionTy);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMGetNamedFunction(LLVMLibrary.LLVMModuleRef M, String Name);
	/**
	...
	public static native LLVMLibrary.LLVMTypeRef LLVMInt128TypeInContext(LLVMLibrary.LLVMContextRef C);
	 ...
	 */
	public static native LLVMLibrary.LLVMTypeRef LLVMFunctionType(LLVMLibrary.LLVMTypeRef ReturnType, LLVMLibrary.LLVMTypeRef ParamTypes, int ParamCount, LLVMLibrary.LLVMBool IsVarArg);
	/**
	 * Returns whether a function type is variadic.<br>
	 * Original signature : <code>LLVMBool LLVMIsFunctionVarArg(LLVMTypeRef)</code>
	 */
	public static native LLVMLibrary.LLVMBool LLVMIsFunctionVarArg(LLVMLibrary.LLVMTypeRef FunctionTy);
	/**
	 ...
	 */
	public static native void LLVMGetParamTypes(LLVMLibrary.LLVMTypeRef FunctionTy, LLVMLibrary.LLVMTypeRef Dest);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMTypeRef LLVMStructTypeInContext(LLVMLibrary.LLVMContextRef C, LLVMLibrary.LLVMTypeRef ElementTypes, int ElementCount, LLVMLibrary.LLVMBool Packed);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMTypeRef LLVMStructType(LLVMLibrary.LLVMTypeRef ElementTypes, int ElementCount, LLVMLibrary.LLVMBool Packed);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMTypeRef LLVMStructCreateNamed(LLVMLibrary.LLVMContextRef C, String Name);
	/**
	 ...
	 */
	public static native void LLVMStructSetBody(LLVMLibrary.LLVMTypeRef StructTy, LLVMLibrary.LLVMTypeRef ElementTypes, int ElementCount, LLVMLibrary.LLVMBool Packed);
	/**
	 ...
	 */
	public static native void LLVMGetStructElementTypes(LLVMLibrary.LLVMTypeRef StructTy, LLVMLibrary.LLVMTypeRef Dest);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMTypeRef LLVMStructGetTypeAtIndex(LLVMLibrary.LLVMTypeRef StructTy, int i);
	/**
	...
	public static native LLVMLibrary.LLVMValueRef LLVMIsAConstantDataSequential(LLVMLibrary.LLVMValueRef Val);
	/** Original signature : <code>LLVMValueRef LLVMIsAConstantDataArray(LLVMValueRef)</code> */
	public static native LLVMLibrary.LLVMValueRef LLVMIsAConstantDataArray(LLVMLibrary.LLVMValueRef Val);
	/** Original signature : <code>LLVMValueRef LLVMIsAConstantDataVector(LLVMValueRef)</code> */
	public static native LLVMLibrary.LLVMValueRef LLVMIsAConstantDataVector(LLVMLibrary.LLVMValueRef Val);
	...
	public static native LLVMLibrary.LLVMValueRef LLVMIsAConstantTokenNone(LLVMLibrary.LLVMValueRef Val);
	...
	public static native LLVMLibrary.LLVMValueRef LLVMIsACleanupReturnInst(LLVMLibrary.LLVMValueRef Val);
	/** Original signature : <code>LLVMValueRef LLVMIsACatchReturnInst(LLVMValueRef)</code> */
	public static native LLVMLibrary.LLVMValueRef LLVMIsACatchReturnInst(LLVMLibrary.LLVMValueRef Val);
	...
	public static native LLVMLibrary.LLVMValueRef LLVMIsAAddrSpaceCastInst(LLVMLibrary.LLVMValueRef Val);
	 ...
	 */
	public static native LLVMLibrary.LLVMUseRef LLVMGetOperandUse(LLVMLibrary.LLVMValueRef Val, int Index);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMConstInt(LLVMLibrary.LLVMTypeRef IntTy, long N, LLVMLibrary.LLVMBool SignExtend);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMConstIntOfArbitraryPrecision(LLVMLibrary.LLVMTypeRef IntTy, int NumWords, long Words[]);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMConstIntOfString(LLVMLibrary.LLVMTypeRef IntTy, String Text, byte Radix);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMConstIntOfStringAndSize(LLVMLibrary.LLVMTypeRef IntTy, String Text, int SLen, byte Radix);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMConstRealOfString(LLVMLibrary.LLVMTypeRef RealTy, String Text);
	/**
	 * Obtain a constant for a floating point value parsed from a string.<br>
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMConstRealOfStringAndSize(LLVMLibrary.LLVMTypeRef RealTy, String Text, int SLen);
	/**
	 ...
	 */
	public static native double LLVMConstRealGetDouble(LLVMLibrary.LLVMValueRef ConstantVal, LLVMLibrary.LLVMBool losesInfo);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMConstStringInContext(LLVMLibrary.LLVMContextRef C, String Str, int Length, LLVMLibrary.LLVMBool DontNullTerminate);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMConstString(String Str, int Length, LLVMLibrary.LLVMBool DontNullTerminate);
	/**
	 ...
	 */
	public static native String LLVMGetAsString(LLVMLibrary.LLVMValueRef c, NativeSizeByReference Length);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMConstStructInContext(LLVMLibrary.LLVMContextRef C, LLVMLibrary.LLVMValueRef ConstantVals, int Count, LLVMLibrary.LLVMBool Packed);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMConstStruct(LLVMLibrary.LLVMValueRef ConstantVals, int Count, LLVMLibrary.LLVMBool Packed);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMConstArray(LLVMLibrary.LLVMTypeRef ElementTy, LLVMLibrary.LLVMValueRef ConstantVals, int Length);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMConstNamedStruct(LLVMLibrary.LLVMTypeRef StructTy, LLVMLibrary.LLVMValueRef ConstantVals, int Count);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMGetElementAsConstant(LLVMLibrary.LLVMValueRef C, int idx);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMConstVector(LLVMLibrary.LLVMValueRef ScalarConstantVals, int Size);
	/**
	...
	public static native LLVMLibrary.LLVMValueRef LLVMConstICmp(int Predicate, LLVMLibrary.LLVMValueRef LHSConstant, LLVMLibrary.LLVMValueRef RHSConstant);
	/** Original signature : <code>LLVMValueRef LLVMConstFCmp(LLVMRealPredicate, LLVMValueRef, LLVMValueRef)</code> */
	public static native LLVMLibrary.LLVMValueRef LLVMConstFCmp(int Predicate, LLVMLibrary.LLVMValueRef LHSConstant, LLVMLibrary.LLVMValueRef RHSConstant);
	...
	public static native LLVMLibrary.LLVMValueRef LLVMConstGEP(LLVMLibrary.LLVMValueRef ConstantVal, LLVMLibrary.LLVMValueRef ConstantIndices, int NumIndices);
	/** Original signature : <code>LLVMValueRef LLVMConstInBoundsGEP(LLVMValueRef, LLVMValueRef*, unsigned)</code> */
	public static native LLVMLibrary.LLVMValueRef LLVMConstInBoundsGEP(LLVMLibrary.LLVMValueRef ConstantVal, LLVMLibrary.LLVMValueRef ConstantIndices, int NumIndices);
	...
	public static native LLVMLibrary.LLVMValueRef LLVMConstAddrSpaceCast(LLVMLibrary.LLVMValueRef ConstantVal, LLVMLibrary.LLVMTypeRef ToType);
	...
	public static native LLVMLibrary.LLVMValueRef LLVMConstIntCast(LLVMLibrary.LLVMValueRef ConstantVal, LLVMLibrary.LLVMTypeRef ToType, LLVMLibrary.LLVMBool isSigned);
	...
	public static native LLVMLibrary.LLVMValueRef LLVMConstInlineAsm(LLVMLibrary.LLVMTypeRef Ty, String AsmString, String Constraints, LLVMLibrary.LLVMBool HasSideEffects, LLVMLibrary.LLVMBool IsAlignStack);
	...
	public static native void LLVMSetUnnamedAddr(LLVMLibrary.LLVMValueRef Global, LLVMLibrary.LLVMBool HasUnnamedAddr);
	/**
	...
	public static native LLVMLibrary.LLVMValueRef LLVMGetNamedGlobal(LLVMLibrary.LLVMModuleRef M, String Name);
	...
	public static native void LLVMSetThreadLocal(LLVMLibrary.LLVMValueRef GlobalVar, LLVMLibrary.LLVMBool IsThreadLocal);
	/** Original signature : <code>LLVMBool LLVMIsGlobalConstant(LLVMValueRef)</code> */
	public static native LLVMLibrary.LLVMBool LLVMIsGlobalConstant(LLVMLibrary.LLVMValueRef GlobalVar);
	/** Original signature : <code>void LLVMSetGlobalConstant(LLVMValueRef, LLVMBool)</code> */
	public static native void LLVMSetGlobalConstant(LLVMLibrary.LLVMValueRef GlobalVar, LLVMLibrary.LLVMBool IsConstant);
	...
	public static native LLVMLibrary.LLVMBool LLVMIsExternallyInitialized(LLVMLibrary.LLVMValueRef GlobalVar);
	/** Original signature : <code>void LLVMSetExternallyInitialized(LLVMValueRef, LLVMBool)</code> */
	public static native void LLVMSetExternallyInitialized(LLVMLibrary.LLVMValueRef GlobalVar, LLVMLibrary.LLVMBool IsExtInit);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMAddAlias(LLVMLibrary.LLVMModuleRef M, LLVMLibrary.LLVMTypeRef Ty, LLVMLibrary.LLVMValueRef Aliasee, String Name);
	/**
	 ...
	 */
	public static native void LLVMSetPersonalityFn(LLVMLibrary.LLVMValueRef Fn, LLVMLibrary.LLVMValueRef PersonalityFn);
	/**
	...
	public static native void LLVMAddAttributeAtIndex(LLVMLibrary.LLVMValueRef F, int Idx, LLVMLibrary.LLVMAttributeRef A);
	...
	public static native void LLVMGetAttributesAtIndex(LLVMLibrary.LLVMValueRef F, int Idx, LLVMLibrary.LLVMAttributeRef Attrs);
	...
	public static native LLVMLibrary.LLVMAttributeRef LLVMGetStringAttributeAtIndex(LLVMLibrary.LLVMValueRef F, int Idx, String K, int KLen);
	...
	public static native void LLVMRemoveStringAttributeAtIndex(LLVMLibrary.LLVMValueRef F, int Idx, String K, int KLen);
	/**
	 ...
	 */
	public static native void LLVMAddTargetDependentFunctionAttr(LLVMLibrary.LLVMValueRef Fn, String A, String V);
	/**
	 ...
	 */
	public static native void LLVMGetParams(LLVMLibrary.LLVMValueRef Fn, LLVMLibrary.LLVMValueRef Params);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMMDStringInContext(LLVMLibrary.LLVMContextRef C, String Str, int SLen);
	/**
	 ...
	 * @deprecated use the safer methods {@link #LLVMMDString(java.lang.String, int)} and {@link #LLVMMDString(com.sun.jna.Pointer, int)} instead
	 */
	@Deprecated 
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMMDNodeInContext(LLVMLibrary.LLVMContextRef C, LLVMLibrary.LLVMValueRef Vals, int Count);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMMDNode(LLVMLibrary.LLVMValueRef Vals, int Count);
	/**
	 ...
	 */
	public static native void LLVMGetMDNodeOperands(LLVMLibrary.LLVMValueRef V, LLVMLibrary.LLVMValueRef Dest);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMGetBasicBlockTerminator(LLVMLibrary.LLVMBasicBlockRef BB);
	/**
	 ...
	 */
	public static native void LLVMGetBasicBlocks(LLVMLibrary.LLVMValueRef Fn, LLVMLibrary.LLVMBasicBlockRef BasicBlocks);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBasicBlockRef LLVMAppendBasicBlockInContext(LLVMLibrary.LLVMContextRef C, LLVMLibrary.LLVMValueRef Fn, String Name);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBasicBlockRef LLVMAppendBasicBlock(LLVMLibrary.LLVMValueRef Fn, String Name);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBasicBlockRef LLVMInsertBasicBlockInContext(LLVMLibrary.LLVMContextRef C, LLVMLibrary.LLVMBasicBlockRef BB, String Name);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBasicBlockRef LLVMInsertBasicBlock(LLVMLibrary.LLVMBasicBlockRef InsertBeforeBB, String Name);
	/**
	...
	public static native void LLVMAddInstrAttribute(LLVMLibrary.LLVMValueRef Instr, int index, int LLVMAttribute1);
	/** Original signature : <code>void LLVMRemoveInstrAttribute(LLVMValueRef, unsigned, LLVMAttribute)</code> */
	public static native void LLVMRemoveInstrAttribute(LLVMLibrary.LLVMValueRef Instr, int index, int LLVMAttribute1);
	...
	public static native void LLVMAddCallSiteAttribute(LLVMLibrary.LLVMValueRef C, int Idx, LLVMLibrary.LLVMAttributeRef A);
	...
	public static native void LLVMGetCallSiteAttributes(LLVMLibrary.LLVMValueRef C, int Idx, LLVMLibrary.LLVMAttributeRef Attrs);
	...
	public static native LLVMLibrary.LLVMAttributeRef LLVMGetCallSiteStringAttribute(LLVMLibrary.LLVMValueRef C, int Idx, String K, int KLen);
	...
	public static native void LLVMRemoveCallSiteStringAttribute(LLVMLibrary.LLVMValueRef C, int Idx, String K, int KLen);
	/**
	 ...
	 */
	public static native void LLVMSetTailCall(LLVMLibrary.LLVMValueRef CallInst, LLVMLibrary.LLVMBool IsTailCall);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBasicBlockRef LLVMGetNormalDest(LLVMLibrary.LLVMValueRef InvokeInst);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBasicBlockRef LLVMGetUnwindDest(LLVMLibrary.LLVMValueRef InvokeInst);
	/**
	 ...
	 */
	public static native void LLVMSetNormalDest(LLVMLibrary.LLVMValueRef InvokeInst, LLVMLibrary.LLVMBasicBlockRef B);
	/**
	 ...
	 */
	public static native void LLVMSetUnwindDest(LLVMLibrary.LLVMValueRef InvokeInst, LLVMLibrary.LLVMBasicBlockRef B);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBasicBlockRef LLVMGetSuccessor(LLVMLibrary.LLVMValueRef Term, int i);
	/**
	 ...
	 */
	public static native void LLVMSetSuccessor(LLVMLibrary.LLVMValueRef Term, int i, LLVMLibrary.LLVMBasicBlockRef block);
	/**
	 ...
	 */
	public static native void LLVMSetCondition(LLVMLibrary.LLVMValueRef Branch, LLVMLibrary.LLVMValueRef Cond);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBasicBlockRef LLVMGetSwitchDefaultDest(LLVMLibrary.LLVMValueRef SwitchInstr);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMTypeRef LLVMGetAllocatedType(LLVMLibrary.LLVMValueRef Alloca);
	/**
	 ...
	 */
	public static native void LLVMSetIsInBounds(LLVMLibrary.LLVMValueRef GEP, LLVMLibrary.LLVMBool InBounds);
	/**
	 ...
	 */
	public static native void LLVMAddIncoming(LLVMLibrary.LLVMValueRef PhiNode, LLVMLibrary.LLVMValueRef IncomingValues, LLVMLibrary.LLVMBasicBlockRef IncomingBlocks, int Count);
	/**
	...
	public static native void LLVMInsertIntoBuilderWithName(LLVMLibrary.LLVMBuilderRef Builder, LLVMLibrary.LLVMValueRef Instr, String Name);
	...
	public static native LLVMLibrary.LLVMValueRef LLVMBuildAggregateRet(LLVMLibrary.LLVMValueRef RetVals, int N);
	...
	public static native LLVMLibrary.LLVMValueRef LLVMBuildCondBr(LLVMLibrary.LLVMValueRef If, LLVMLibrary.LLVMBasicBlockRef Then, LLVMLibrary.LLVMBasicBlockRef Else);
	/** Original signature : <code>LLVMValueRef LLVMBuildSwitch(LLVMValueRef, LLVMBasicBlockRef, unsigned)</code> */
	public static native LLVMLibrary.LLVMValueRef LLVMBuildSwitch(LLVMLibrary.LLVMValueRef V, LLVMLibrary.LLVMBasicBlockRef Else, int NumCases);
	...
	public static native LLVMLibrary.LLVMValueRef LLVMBuildLandingPad(LLVMLibrary.LLVMBuilderRef B, LLVMLibrary.LLVMTypeRef Ty, LLVMLibrary.LLVMValueRef PersFn, int NumClauses, String Name);
	/** Original signature : <code>LLVMValueRef LLVMBuildResume(LLVMBuilderRef, LLVMValueRef)</code> */
	public static native LLVMLibrary.LLVMValueRef LLVMBuildResume(LLVMLibrary.LLVMBuilderRef B, LLVMLibrary.LLVMValueRef Exn);
	 ...
	 */
	public static native LLVMLibrary.LLVMValueRef LLVMGetClause(LLVMLibrary.LLVMValueRef LandingPad, int Idx);
	/**
	 ...
	 */
	public static native void LLVMAddClause(LLVMLibrary.LLVMValueRef LandingPad, LLVMLibrary.LLVMValueRef ClauseVal);
	/**
	 ...
	 */
	public static native void LLVMSetCleanup(LLVMLibrary.LLVMValueRef LandingPad, LLVMLibrary.LLVMBool Val);
	/**
	 * Arithmetic<br>
	...
	public static native LLVMLibrary.LLVMValueRef LLVMBuildNot(LLVMLibrary.LLVMValueRef V, String Name);
	/**
	 * Memory<br>
	...
	public static native LLVMLibrary.LLVMValueRef LLVMBuildArrayAlloca(LLVMLibrary.LLVMTypeRef Ty, LLVMLibrary.LLVMValueRef Val, String Name);
	...
	public static native LLVMLibrary.LLVMValueRef LLVMBuildLoad(LLVMLibrary.LLVMValueRef PointerVal, String Name);
	...
	public static native LLVMLibrary.LLVMValueRef LLVMBuildGlobalStringPtr(LLVMLibrary.LLVMBuilderRef B, String Str, String Name);
	/** Original signature : <code>LLVMBool LLVMGetVolatile(LLVMValueRef)</code> */
	public static native LLVMLibrary.LLVMBool LLVMGetVolatile(LLVMLibrary.LLVMValueRef MemoryAccessInst);
	/** Original signature : <code>void LLVMSetVolatile(LLVMValueRef, LLVMBool)</code> */
	public static native void LLVMSetVolatile(LLVMLibrary.LLVMValueRef MemoryAccessInst, LLVMLibrary.LLVMBool IsVolatile);
	...
	public static native void LLVMSetOrdering(LLVMLibrary.LLVMValueRef MemoryAccessInst, int Ordering);
	/**
	 * Casts<br>
	...
	public static native LLVMLibrary.LLVMValueRef LLVMBuildPointerCast(LLVMLibrary.LLVMValueRef Val, LLVMLibrary.LLVMTypeRef DestTy, String Name);
	/**
	 * Signed cast!<br>
	...
	public static native LLVMLibrary.LLVMValueRef LLVMBuildFPCast(LLVMLibrary.LLVMValueRef Val, LLVMLibrary.LLVMTypeRef DestTy, String Name);
	/**
	 * Comparisons<br>
	...
	public static native LLVMLibrary.LLVMValueRef LLVMBuildFCmp(int Op, LLVMLibrary.LLVMValueRef LHS, LLVMLibrary.LLVMValueRef RHS, String Name);
	/**
	...
	public static native LLVMLibrary.LLVMValueRef LLVMBuildFence(LLVMLibrary.LLVMBuilderRef B, int ordering, LLVMLibrary.LLVMBool singleThread, String Name);
	...
	public static native LLVMLibrary.LLVMValueRef LLVMBuildAtomicRMW(LLVMLibrary.LLVMBuilderRef B, int op, LLVMLibrary.LLVMValueRef PTR, LLVMLibrary.LLVMValueRef Val, int ordering, LLVMLibrary.LLVMBool singleThread);
	...
	public static native LLVMLibrary.LLVMValueRef LLVMBuildAtomicCmpXchg(LLVMLibrary.LLVMBuilderRef B, LLVMLibrary.LLVMValueRef Ptr, LLVMLibrary.LLVMValueRef Cmp, LLVMLibrary.LLVMValueRef New, int SuccessOrdering, int FailureOrdering, LLVMLibrary.LLVMBool SingleThread);
	/** Original signature : <code>LLVMBool LLVMIsAtomicSingleThread(LLVMValueRef)</code> */
	public static native LLVMLibrary.LLVMBool LLVMIsAtomicSingleThread(LLVMLibrary.LLVMValueRef AtomicInst);
	/** Original signature : <code>void LLVMSetAtomicSingleThread(LLVMValueRef, LLVMBool)</code> */
	public static native void LLVMSetAtomicSingleThread(LLVMLibrary.LLVMValueRef AtomicInst, LLVMLibrary.LLVMBool SingleThread);
	...
	public static native void LLVMSetCmpXchgSuccessOrdering(LLVMLibrary.LLVMValueRef CmpXchgInst, int Ordering);
	...
	public static native void LLVMSetCmpXchgFailureOrdering(LLVMLibrary.LLVMValueRef CmpXchgInst, int Ordering);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBool LLVMCreateMemoryBufferWithContentsOfFile(String Path, LLVMLibrary.LLVMMemoryBufferRef OutMemBuf, PointerByReference OutMessage);
	...
	public static native LLVMLibrary.LLVMMemoryBufferRef LLVMCreateMemoryBufferWithMemoryRange(String InputData, NativeSize InputDataLength, String BufferName, LLVMLibrary.LLVMBool RequiresNullTerminator);
	/**
	 * Original signature : <code>LLVMMemoryBufferRef LLVMCreateMemoryBufferWithMemoryRangeCopy(const char*, size_t, const char*)</code><br>
	 * @deprecated use the safer methods {@link #LLVMCreateMemoryBufferWithMemoryRangeCopy(java.lang.String, com.ochafik.lang.jnaerator.runtime.NativeSize, java.lang.String)} and {@link #LLVMCreateMemoryBufferWithMemoryRangeCopy(com.sun.jna.Pointer, com.ochafik.lang.jnaerator.runtime.NativeSize, com.sun.jna.Pointer)} instead
	 */
	@Deprecated 
	public static native LLVMLibrary.LLVMMemoryBufferRef LLVMCreateMemoryBufferWithMemoryRangeCopy(Pointer InputData, NativeSize InputDataLength, Pointer BufferName);
	/** Original signature : <code>LLVMMemoryBufferRef LLVMCreateMemoryBufferWithMemoryRangeCopy(const char*, size_t, const char*)</code> */
	public static native LLVMLibrary.LLVMMemoryBufferRef LLVMCreateMemoryBufferWithMemoryRangeCopy(String InputData, NativeSize InputDataLength, String BufferName);
	 ...
	 */
	public static native LLVMLibrary.LLVMBool LLVMRunPassManager(LLVMLibrary.LLVMPassManagerRef PM, LLVMLibrary.LLVMModuleRef M);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBool LLVMInitializeFunctionPassManager(LLVMLibrary.LLVMPassManagerRef FPM);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBool LLVMRunFunctionPassManager(LLVMLibrary.LLVMPassManagerRef FPM, LLVMLibrary.LLVMValueRef F);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBool LLVMFinalizeFunctionPassManager(LLVMLibrary.LLVMPassManagerRef FPM);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBool LLVMVerifyModule(LLVMLibrary.LLVMModuleRef M, int Action, PointerByReference OutMessage);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBool LLVMVerifyFunction(LLVMLibrary.LLVMValueRef Fn, int Action);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMMemoryBufferRef LLVMWriteBitcodeToMemoryBuffer(LLVMLibrary.LLVMModuleRef M);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBool LLVMParseBitcode(LLVMLibrary.LLVMMemoryBufferRef MemBuf, LLVMLibrary.LLVMModuleRef OutModule, PointerByReference OutMessage);
	/**
	 * Builds a module from the bitcode in the specified memory buffer, returning a<br>
	 * reference to the module via the OutModule parameter. Returns 0 on success.<br>
	 * Original signature : <code>LLVMBool LLVMParseBitcode2(LLVMMemoryBufferRef, LLVMModuleRef*)</code>
	 */
	public static native LLVMLibrary.LLVMBool LLVMParseBitcode2(LLVMLibrary.LLVMMemoryBufferRef MemBuf, LLVMLibrary.LLVMModuleRef OutModule);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBool LLVMParseBitcodeInContext(LLVMLibrary.LLVMContextRef ContextRef, LLVMLibrary.LLVMMemoryBufferRef MemBuf, LLVMLibrary.LLVMModuleRef OutModule, PointerByReference OutMessage);
	/** Original signature : <code>LLVMBool LLVMParseBitcodeInContext2(LLVMContextRef, LLVMMemoryBufferRef, LLVMModuleRef*)</code> */
	public static native LLVMLibrary.LLVMBool LLVMParseBitcodeInContext2(LLVMLibrary.LLVMContextRef ContextRef, LLVMLibrary.LLVMMemoryBufferRef MemBuf, LLVMLibrary.LLVMModuleRef OutModule);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBool LLVMGetBitcodeModuleInContext(LLVMLibrary.LLVMContextRef ContextRef, LLVMLibrary.LLVMMemoryBufferRef MemBuf, LLVMLibrary.LLVMModuleRef OutM, PointerByReference OutMessage);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBool LLVMGetBitcodeModuleInContext2(LLVMLibrary.LLVMContextRef ContextRef, LLVMLibrary.LLVMMemoryBufferRef MemBuf, LLVMLibrary.LLVMModuleRef OutM);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMBool LLVMGetBitcodeModule(LLVMLibrary.LLVMMemoryBufferRef MemBuf, LLVMLibrary.LLVMModuleRef OutM, PointerByReference OutMessage);
	/** Original signature : <code>LLVMBool LLVMGetBitcodeModule2(LLVMMemoryBufferRef, LLVMModuleRef*)</code> */
	public static native LLVMLibrary.LLVMBool LLVMGetBitcodeModule2(LLVMLibrary.LLVMMemoryBufferRef MemBuf, LLVMLibrary.LLVMModuleRef OutM);
	...
	public static native void LLVMMoveToContainingSection(LLVMLibrary.LLVMSectionIteratorRef Sect, LLVMLibrary.LLVMSymbolIteratorRef Sym);
	/**
	...
	public static native LLVMLibrary.LLVMBool LLVMGetSectionContainsSymbol(LLVMLibrary.LLVMSectionIteratorRef SI, LLVMLibrary.LLVMSymbolIteratorRef Sym);
	/**
	...
	public static native String LLVMGetRelocationValueString(LLVMLibrary.LLVMRelocationIteratorRef RI);
	/**
	 * Obtain the data layout for a module.<br>
	 * @see Module::getDataLayout()<br>
	 * Original signature : <code>LLVMTargetDataRef LLVMGetModuleDataLayout(LLVMModuleRef)</code>
	 */
	public static native LLVMLibrary.LLVMTargetDataRef LLVMGetModuleDataLayout(LLVMLibrary.LLVMModuleRef M);
	/**
	 * Set the data layout for a module.<br>
	 * @see Module::setDataLayout()<br>
	 ...
	 */
	public static native void LLVMSetModuleDataLayout(LLVMLibrary.LLVMModuleRef M, LLVMLibrary.LLVMTargetDataRef DL);
	/**
	 ...
	 * @deprecated use the safer methods {@link #LLVMCreateTargetData(java.lang.String)} and {@link #LLVMCreateTargetData(com.sun.jna.Pointer)} instead
	 */
	@Deprecated 
	 ...
	 */
	public static native void LLVMAddTargetLibraryInfo(LLVMLibrary.LLVMTargetLibraryInfoRef TLI, LLVMLibrary.LLVMPassManagerRef PM);
	/**
	 ...
	 */
	public static native LLVMLibrary.LLVMTypeRef LLVMIntPtrTypeForAS(LLVMLibrary.LLVMTargetDataRef TD, int AS);
	/**
	 * Returns the integer type that is the same size as a pointer on a target.<br>
	 * See the method llvm::DataLayout::getIntPtrType.<br>
	 ...
	 */
	public static native LLVMLibrary.LLVMTypeRef LLVMIntPtrTypeInContext(LLVMLibrary.LLVMContextRef C, LLVMLibrary.LLVMTargetDataRef TD);
	/**
	 * Returns the integer type that is the same size as a pointer on a target.<br>
	 * This version allows the address space to be specified.<br>
	 * See the method llvm::DataLayout::getIntPtrType.<br>
	 ...
	 */
	public static native LLVMLibrary.LLVMTypeRef LLVMIntPtrTypeForASInContext(LLVMLibrary.LLVMContextRef C, LLVMLibrary.LLVMTargetDataRef TD, int AS);
	/**
	 ...
	 */
	public static native long LLVMSizeOfTypeInBits(LLVMLibrary.LLVMTargetDataRef TD, LLVMLibrary.LLVMTypeRef Ty);
	/**
	 ...
	 */
	public static native long LLVMStoreSizeOfType(LLVMLibrary.LLVMTargetDataRef TD, LLVMLibrary.LLVMTypeRef Ty);
	/**
	 ...
	 */
	public static native long LLVMABISizeOfType(LLVMLibrary.LLVMTargetDataRef TD, LLVMLibrary.LLVMTypeRef Ty);
	/**
	 ...
	 */
	public static native int LLVMABIAlignmentOfType(LLVMLibrary.LLVMTargetDataRef TD, LLVMLibrary.LLVMTypeRef Ty);
	/**
	 ...
	 */
	public static native int LLVMCallFrameAlignmentOfType(LLVMLibrary.LLVMTargetDataRef TD, LLVMLibrary.LLVMTypeRef Ty);
	/**
	 ...
	 */
	public static native int LLVMPreferredAlignmentOfType(LLVMLibrary.LLVMTargetDataRef TD, LLVMLibrary.LLVMTypeRef Ty);
	/**
	 ...
	 */
	public static native int LLVMPreferredAlignmentOfGlobal(LLVMLibrary.LLVMTargetDataRef TD, LLVMLibrary.LLVMValueRef GlobalVar);
	/**
	 ...
	 */
	public static native int LLVMElementAtOffset(LLVMLibrary.LLVMTargetDataRef TD, LLVMLibrary.LLVMTypeRef StructTy, long Offset);
	/**
	 ...
	 */
	public static native long LLVMOffsetOfElement(LLVMLibrary.LLVMTargetDataRef TD, LLVMLibrary.LLVMTypeRef StructTy, int Element);
